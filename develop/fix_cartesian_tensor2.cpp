...
SECTION("T2.det() -- 3D")
{
  ...
  cppmat::tiny::cartesian::tensor2<double,3> A = cppmat::tiny::cartesian::tensor2<double,3>::Copy(a.data());
  double C = A.det();
...
SECTION("T2.det() -- 2D")
{
  ...
  cppmat::tiny::cartesian::tensor2<double,2> A = cppmat::tiny::cartesian::tensor2<double,2>::Copy(a.data());
  double C = A.det();
...
SECTION("T2.inv() -- 3D")
{
  ...
  cppmat::tiny::cartesian::tensor2<double,3> A = cppmat::tiny::cartesian::tensor2<double,3>::Copy(a.data());
  cppmat::tiny::cartesian::tensor2<double,3> C = A.inv();
...
SECTION("T2.inv() -- 2D")
{
  ...
  cppmat::tiny::cartesian::tensor2<double,2> A = cppmat::tiny::cartesian::tensor2<double,2>::Copy(a.data());
  cppmat::tiny::cartesian::tensor2<double,2> C = A.inv();
