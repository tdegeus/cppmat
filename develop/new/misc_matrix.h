...
#ifndef CPPMAT_MISC_MATRIX_H
#define CPPMAT_MISC_MATRIX_H
...
template<class X> inline cppmat::matrix<X> operator* (
...
template<class X> inline cppmat::symmetric::matrix<X> operator+ (
  const cppmat::symmetric::matrix<X> &A,
  const cppmat::diagonal::matrix<X> &B
);
...
template<class X> inline cppmat::diagonal::matrix<X> operator* (
  const cppmat::diagonal::matrix<X> &A,
  const cppmat::matrix<X> &B
);
