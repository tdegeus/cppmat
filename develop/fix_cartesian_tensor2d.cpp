...
TEST_CASE("cppmat::tiny::cartesian::tensor2d", "var_cartesian_tensor2s.h")
{
...
SECTION("T2d.det() -- 3D")
{
  ...
  cppmat::tiny::cartesian::tensor2d<double,3> A = cppmat::tiny::cartesian::tensor2d<double,3>::CopyDense(a.data(), a.data()+a.size());
  double C = A.det();
...
SECTION("T2d.det() -- 2D")
{
  ...
  cppmat::tiny::cartesian::tensor2d<double,2> A = cppmat::tiny::cartesian::tensor2d<double,2>::CopyDense(a.data(), a.data()+a.size());
  double C = A.det();
...
SECTION("T2d.inv() -- 3D")
{
  ...
  cppmat::tiny::cartesian::tensor2d<double,3> A = cppmat::tiny::cartesian::tensor2d<double,3>::CopyDense(a.data(), a.data()+a.size());
  cppmat::tiny::cartesian::tensor2d<double,3> C = A.inv();
...
SECTION("T2d.inv() -- 2D")
{
  ...
  cppmat::tiny::cartesian::tensor2d<double,2> A = cppmat::tiny::cartesian::tensor2d<double,2>::CopyDense(a.data(), a.data()+a.size());
  cppmat::tiny::cartesian::tensor2d<double,2> C = A.inv();
