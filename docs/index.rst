...
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian2d::tensor4<T>` | n-d tensors of rank 4                     | :ref:`tensor2`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian2d::tensor2<T>` | n-d tensors of rank 2                     | :ref:`tensor2`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian2d::tensor2s<T>`| n-d symmetric tensors of rank 2           | :ref:`tensor2`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian2d::tensor2d<T>`| n-d diagonal tensors of rank 2            | :ref:`tensor2`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian3d::vector<T>`  | n-d diagonal vectors (tensors of rank 1)  | :ref:`tensor3`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian3d::tensor4<T>` | n-d tensors of rank 4                     | :ref:`tensor3`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian3d::tensor2<T>` | n-d tensors of rank 2                     | :ref:`tensor3`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian3d::tensor2s<T>`| n-d symmetric tensors of rank 2           | :ref:`tensor3`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian3d::tensor2d<T>`| n-d diagonal tensors of rank 2            | :ref:`tensor3`      |
+-----------------------------------+-------------------------------------------+---------------------+
| `cppmat::cartesian3d::vector<T>`  | n-d diagonal vectors (tensors of rank 1)  | :ref:`tensor3`      |
+-----------------------------------+-------------------------------------------+---------------------+
