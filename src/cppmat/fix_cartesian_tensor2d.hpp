...
#ifndef CPPMAT_FIX_CARTESIAN_TENSOR2D_HPP
#define CPPMAT_FIX_CARTESIAN_TENSOR2D_HPP
...
inline
tensor2d<X,ND>::tensor2d(const cppmat::tiny::diagonal::matrix<U,ND,ND> &A) : cppmat::tiny::diagonal::matrix<X,ND,ND>(A)
{
}
