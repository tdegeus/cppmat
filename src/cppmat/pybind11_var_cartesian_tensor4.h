...
#ifndef CPPMAT_VAR_CARTESIAN_TENSOR4_PYBIND11_H
#define CPPMAT_VAR_CARTESIAN_TENSOR4_PYBIND11_H
...
template<class X> struct type_caster<cppmat::cartesian::tensor4<X>>
{
public:
