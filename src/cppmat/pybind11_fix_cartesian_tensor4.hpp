...
#ifndef CPPMAT_FIX_CARTESIAN_TENSOR4_PYBIND11_HPP
#define CPPMAT_FIX_CARTESIAN_TENSOR4_PYBIND11_HPP
...
// =================================================================================================
// type caster: cppmat::tiny::cartesian::tensor4 <-> NumPy-array
// =================================================================================================

template<typename X, size_t ND> struct type_caster<cppmat::tiny::cartesian::tensor4<X,ND>>
{
public:
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::tiny::cartesian::tensor4<X,ND>::Copy(buf.data(), buf.data()+buf.size());
  ...
  static py::handle cast(
    const cppmat::tiny::cartesian::tensor4<X,ND>& src, py::return_value_policy policy, py::handle parent
  )
  {
