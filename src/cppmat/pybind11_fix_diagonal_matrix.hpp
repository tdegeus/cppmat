...
#ifndef CPPMAT_FIX_DIAGONAL_MATRIX_PYBIND11_HPP
#define CPPMAT_FIX_DIAGONAL_MATRIX_PYBIND11_HPP
...
template<typename X, size_t M, size_t N> struct type_caster<cppmat::tiny::diagonal::matrix<X,M,N>>
{
public:

  using Arr = cppmat::tiny::diagonal::matrix<X,M,N>;

  PYBIND11_TYPE_CASTER(Arr, _("cppmat::tiny::diagonal::matrix<X,M,N>"));
  ...
  static py::handle cast(const cppmat::tiny::diagonal::matrix<X,M,N>& src,
