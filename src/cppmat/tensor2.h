...
namespace map = cppmat::view::cartesian2d;
...
private:
  ...
  X mData[16];                  // data container
  static const size_t mNd=2;    // number of dimensions (rank == 4 -> shape == [mNd,mNd,mNd,mNd])
  static const size_t mSize=16; // == mData.size() == mNd*mNd*mNd*mNd
...
private:
  ...
  X mData[4];                  // data container
  static const size_t mNd=2;   // number of dimensions (rank == 2 -> shape == [mNd,mNd])
  static const size_t mSize=4; // == mData.size() == mNd*mNd
...
private:
  ...
  static const size_t mNd=2;   // number of dimensions (rank == 2 -> shape == [mNd,mNd])
  static const size_t mSize=3; // == mData.size() == (mNd+1)*mNd/2
...
private:
  ...
  X mData[2];                  // data container
  static const size_t mNd=2;   // number of dimensions (rank == 2 -> shape == [mNd,mNd])
  static const size_t mSize=2; // == mData.size() == mNd
...
private:
  ...
  X mData[2];                  // data container
  static const size_t mNd=2;   // number of dimensions (rank == 1 -> shape == [mNd])
  static const size_t mSize=2; // == mData.size() == mNd
