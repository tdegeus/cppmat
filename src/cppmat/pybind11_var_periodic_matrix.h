...
#ifndef CPPMAT_VAR_PERIODIC_MATRIX_PYBIND11_H
#define CPPMAT_VAR_PERIODIC_MATRIX_PYBIND11_H
...
template<class X> struct type_caster<cppmat::periodic::matrix<X>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::periodic::matrix<X>, _("cppmat::periodic::matrix<X>"));
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::periodic::matrix<X>::Copy(m, n, buf.data(), buf.data()+buf.size());
  ...
  static py::handle cast(
    const cppmat::periodic::matrix<X>& src, py::return_value_policy policy, py::handle parent
  )
  {
