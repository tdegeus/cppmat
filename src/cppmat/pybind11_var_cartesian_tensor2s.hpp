...
#ifndef CPPMAT_VAR_CARTESIAN_TENSOR2S_PYBIND11_HPP
#define CPPMAT_VAR_CARTESIAN_TENSOR2S_PYBIND11_HPP
...
template<typename X> struct type_caster<cppmat::cartesian::tensor2s<X>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::cartesian::tensor2s<X>, _("cppmat::cartesian::tensor2s<X>"));
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::cartesian::tensor2s<X>::CopyDense(nd, buf.data(), buf.data()+buf.size());
