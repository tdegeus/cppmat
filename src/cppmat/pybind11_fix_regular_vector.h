...
#ifndef CPPMAT_FIX_REGULAR_VECTOR_PYBIND11_H
#define CPPMAT_FIX_REGULAR_VECTOR_PYBIND11_H
...
template<class X, size_t N> struct type_caster<cppmat::tiny::vector<X,N>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::tiny::vector<X,N>, _("cppmat::tiny::vector<X,N>"));
