...
#ifndef CPPMAT_FIX_CARTESIAN_TENSOR2_PYBIND11_H
#define CPPMAT_FIX_CARTESIAN_TENSOR2_PYBIND11_H
...
public:
  ...
  PYBIND11_TYPE_CASTER(cppmat::tiny::cartesian::tensor2<X,ND>, _("cppmat::tiny::cartesian::tensor2<X,ND>"));
