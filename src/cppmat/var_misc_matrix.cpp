...
template<class X>
inline
cppmat::symmetric::matrix<X>& cppmat::symmetric::matrix<X>::operator*= (
...
template<class X>
inline
cppmat::diagonal::matrix<X>& cppmat::diagonal::matrix<X>::operator*= (
...
template<class X>
inline
cppmat::matrix<X> operator* (const cppmat::matrix<X> &A, const cppmat::symmetric::matrix<X> &B)
{
...
template<class X>
inline
cppmat::matrix<X> operator+ (const cppmat::matrix<X> &A, const cppmat::diagonal::matrix<X> &B)
{
  assert( A.shape() == B.shape() );
...
template<class X>
inline
cppmat::matrix<X> operator* (const cppmat::symmetric::matrix<X> &A, const cppmat::matrix<X> &B)
{
  assert( A.shape() == B.shape() );
...
template<class X>
inline
cppmat::matrix<X> operator+ (const cppmat::diagonal::matrix<X> &A, const cppmat::matrix<X> &B)
{
  assert( A.shape() == B.shape() );
...
cppmat::symmetric::matrix<X> operator+ (
  const cppmat::symmetric::matrix<X> &A, const cppmat::diagonal::matrix<X> &B)
{
  assert( A.shape() == B.shape() );
...
template<class X>
inline
cppmat::symmetric::matrix<X> operator+ (const cppmat::diagonal::matrix<X> &A, const X &B)
{
  size_t N = A.shape(0);
...
inline
cppmat::symmetric::matrix<X> operator+ (
  const cppmat::diagonal::matrix<X> &A, const cppmat::symmetric::matrix<X> &B)
{
  assert( A.shape() == B.shape() );
...
template<class X>
inline
cppmat::symmetric::matrix<X> operator+ (const X &A, const cppmat::diagonal::matrix<X> &B)
{
  size_t N = B.shape(0);
...
cppmat::diagonal::matrix<X> operator* (
  const cppmat::diagonal::matrix<X> &A, const cppmat::matrix<X> &B)
{
  assert( A.shape() == B.shape() );
...
inline
cppmat::diagonal::matrix<X> operator* (
  const cppmat::matrix<X> &A, const cppmat::diagonal::matrix<X> &B)
{
  assert( A.shape() == B.shape() );
