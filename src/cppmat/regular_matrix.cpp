...
template<class X>
inline auto matrix<X>::item(size_t a)
{
  assert( a < M );
...
template<class X>
inline auto matrix<X>::item(size_t a) const
{
  assert( a < M );
...
template<class X>
inline auto matrix<X>::item(size_t a, size_t b)
{
  assert( a < M );
  assert( b < N );
...
template<class X>
inline auto matrix<X>::item(size_t a, size_t b) const
{
  assert( a < M );
  assert( b < N );
