...
#ifndef CPPMAT_FIX_PERIODIC_MATRIX_PYBIND11_H
#define CPPMAT_FIX_PERIODIC_MATRIX_PYBIND11_H
...
// =================================================================================================
// type caster: cppmat::tiny::periodic::matrix <-> NumPy-array
// =================================================================================================

template<class X, size_t M, size_t N> struct type_caster<cppmat::tiny::periodic::matrix<X,M,N>>
{
public:

  using Arr = cppmat::tiny::periodic::matrix<X,M,N>;

  PYBIND11_TYPE_CASTER(Arr, _("cppmat::tiny::periodic::matrix<X,M,N>"));
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::tiny::periodic::matrix<X,M,N>::Copy(buf.data(), buf.data()+buf.size());
  ...
  static py::handle cast(
    const cppmat::tiny::periodic::matrix<X,M,N>& src, py::return_value_policy policy, py::handle parent
  )
  {
