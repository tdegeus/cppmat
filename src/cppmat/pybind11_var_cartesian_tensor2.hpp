...
#ifndef CPPMAT_VAR_CARTESIAN_TENSOR2_PYBIND11_HPP
#define CPPMAT_VAR_CARTESIAN_TENSOR2_PYBIND11_HPP
...
template<typename X> struct type_caster<cppmat::cartesian::tensor2<X>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::cartesian::tensor2<X>, _("cppmat::cartesian::tensor2<X>"));
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::cartesian::tensor2<X>::Copy(nd, buf.data(), buf.data()+buf.size());
  ...
  static py::handle cast(
    const cppmat::cartesian::tensor2<X>& src, py::return_value_policy policy, py::handle parent
  )
  {
