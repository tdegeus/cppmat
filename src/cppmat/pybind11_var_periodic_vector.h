...
#ifndef CPPMAT_VAR_PERIODIC_VECTOR_PYBIND11_H
#define CPPMAT_VAR_PERIODIC_VECTOR_PYBIND11_H
...
template<class X> struct type_caster<cppmat::periodic::vector<X>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::periodic::vector<X>, _("cppmat::periodic::vector<X>"));
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::periodic::vector<X>::Copy(buf.data(), buf.data()+buf.size());
  ...
  static py::handle cast(
    const cppmat::periodic::vector<X>& src, py::return_value_policy policy, py::handle parent
  )
  {
