...
#ifndef CPPMAT_VAR_SYMMETRIC_MATRIX_PYBIND11_H
#define CPPMAT_VAR_SYMMETRIC_MATRIX_PYBIND11_H
...
template<class X> struct type_caster<cppmat::symmetric::matrix<X>>
{
public:
