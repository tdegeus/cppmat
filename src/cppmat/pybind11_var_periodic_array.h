...
#ifndef CPPMAT_VAR_PERIODIC_ARRAY_PYBIND11_H
#define CPPMAT_VAR_PERIODIC_ARRAY_PYBIND11_H
...
template<class X> struct type_caster<cppmat::periodic::array<X>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::periodic::array<X>, _("cppmat::periodic::array<X>"));
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::periodic::array<X>::Copy(shape, buf.data(), buf.data()+buf.size());
  ...
  static py::handle cast(
    const cppmat::periodic::array<X>& src, py::return_value_policy policy, py::handle parent
  )
  {
