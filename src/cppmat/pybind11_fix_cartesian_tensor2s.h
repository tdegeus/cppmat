...
#ifndef CPPMAT_FIX_CARTESIAN_TENSOR2S_PYBIND11_H
#define CPPMAT_FIX_CARTESIAN_TENSOR2S_PYBIND11_H
...
template<class X, size_t ND> struct type_caster<cppmat::tiny::cartesian::tensor2s<X,ND>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::tiny::cartesian::tensor2s<X,ND>, _("cppmat::tiny::cartesian::tensor2s<X,ND>"));
  ...
  static py::handle cast(
    const cppmat::tiny::cartesian::tensor2s<X,ND>& src, py::return_value_policy policy, py::handle parent
  )
  {
