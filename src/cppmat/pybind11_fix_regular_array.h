...
#ifndef CPPMAT_FIX_REGULAR_ARRAY_PYBIND11_H
#define CPPMAT_FIX_REGULAR_ARRAY_PYBIND11_H
...
template<class X, size_t I, size_t J, size_t K, size_t L, size_t M, size_t N> struct type_caster<cppmat::tiny::array<X,I,J,K,L,M,N>>
{
public:

  PYBIND11_TYPE_CASTER(cppmat::tiny::array<X,I,J,K,L,M,N>, _("cppmat::tiny::array<X,I,J,K,L,M,N>"));
  ...
  bool load(py::handle src, bool convert)
  {
    ...
    value = cppmat::tiny::array<X,I,J,K,L,M,N>::Copy(buf.data(), buf.data()+buf.size());
  ...
  static py::handle cast(
    const cppmat::tiny::array<X,I,J,K,L,M,N>& src, py::return_value_policy policy, py::handle parent
  )
  {
