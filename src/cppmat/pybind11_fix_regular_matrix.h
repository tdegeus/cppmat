...
#ifndef CPPMAT_FIX_REGULAR_MATRIX_PYBIND11_H
#define CPPMAT_FIX_REGULAR_MATRIX_PYBIND11_H
...
template<class X, size_t M, size_t N> struct type_caster<cppmat::tiny::matrix<X,M,N>>
{
public:
  ...
  static py::handle cast(
    const cppmat::tiny::matrix<X,M,N>& src, py::return_value_policy policy, py::handle parent
  )
  {
