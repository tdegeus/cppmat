...
#ifndef CPPMAT_FIX_SYMMETRIC_MATRIX_PYBIND11_H
#define CPPMAT_FIX_SYMMETRIC_MATRIX_PYBIND11_H
...
public:
  ...
  PYBIND11_TYPE_CASTER(cppmat::tiny::symmetric::matrix<X,M,N>, _("cppmat::tiny::symmetric::matrix<X,M,N>"));
  ...
  static py::handle cast(
    const cppmat::tiny::symmetric::matrix<X,M,N>& src, py::return_value_policy policy, py::handle parent
  )
  {
