...
#ifndef CPPMAT_VAR_CARTESIAN_TENSOR2D_PYBIND11_H
#define CPPMAT_VAR_CARTESIAN_TENSOR2D_PYBIND11_H
...
template<class X> struct type_caster<cppmat::cartesian::tensor2d<X>>
{
public:
  ...
  static py::handle cast(
    const cppmat::cartesian::tensor2d<X>& src, py::return_value_policy policy, py::handle parent
  )
  {
