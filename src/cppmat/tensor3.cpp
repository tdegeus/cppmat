...
{
  return ( tensor4<X>::I() + tensor4<X>::Irt() ) / 2.;
}
...
inline void tensor2<X>::setI()
{
  ...
  m_data[4] = static_cast<X>(1);
  m_data[5] = static_cast<X>(0);
  m_data[6] = static_cast<X>(0);
  m_data[7] = static_cast<X>(0);
